...
//initialize empty arrays for employees, roles and departments that will be synced with database each time the API call is made to retrieve these items
let employees = [];
let roles = [];
let departments = [];

//get departments from database, set departments array equal to the response
...
//get employees, set employees array equal to the response
const getEmployees = () => {
...
//get roles, set roles array equal to the response
const getRoles = () => {
...
//ask the user what the name of the department to be added is
const promptAddDepartment = () => {
    ...
    //after department is added get departments from database and sync departments array with response
    getDepartments();
};
...
//On app initialization get departments, employees and roles from database and populate the respective arrays with the responses
